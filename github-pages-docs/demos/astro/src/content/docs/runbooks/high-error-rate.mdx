---
title: 'High Error Rate — Acme Order Service'
description: 'Runbook for the order service high-error-rate alert: severity, fast-path mitigation, diagnostics, decision flowchart.'
severity: SEV-2
---
