---
title: 'Rotate API Gateway Database Credentials'
description: 'SOP for rotating the API gateway auth database credential without dropping authenticated traffic.'
